...
#if defined(NDEBUG)
# error "Disse cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "Disse Signed Message:\n";
...
{
    int64_t nSubsidy = nCoinAge * COIN_YEAR_REWARD * 33 / (365 * 33 + 8); // 52%per annual year
